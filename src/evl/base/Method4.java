...
public class Method4<ReturnType> extends BaseMethod4D<ReturnType, Void> {
	...
	public Method4(MethodComparatorD<Void> methodComparator, Map<ClassTuple, DispatchableMethodD<Void>> cacheMap) {
	...
	public static class Builder<ReturnType> {
		...
		private Map<ClassTuple, DispatchableMethodD<Void>> cacheMap = CacheFactory.<ClassTuple, DispatchableMethodD<Void>>createBoundedCache(10000);
