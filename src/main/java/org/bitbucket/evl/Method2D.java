...
public class Method2D<ReturnType, DataType> extends InvokableMethod2D<ReturnType> {
	...
	public Method2D<ReturnType, DataType> comparator(MethodComparatorD methodComparator) {
