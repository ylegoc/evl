...
public class SymmetricComparator extends MethodComparator {
	...
	/**
	 *  Compares two {@link MethodItem} objects using the product distance comparison.
	 */
	@Override
	public int compare(MethodItem m1, MethodItem m2) {
		return super.compareWithPriority(m1, m2, ProductDistanceComparator.compare(m1.getDistanceTuple(), m2.getDistanceTuple()));
	}
}
