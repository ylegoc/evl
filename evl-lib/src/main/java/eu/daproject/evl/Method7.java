 ...
 */
public class Method7<ReturnType> extends MultiMethod<ReturnType> {
	...
	protected MethodHandle processAndCache(Object... args) {
		...
		cache.put(new ClassTuple(args[0].getClass(), args[1].getClass(), args[2].getClass(), args[3].getClass(), args[4].getClass(), args[5].getClass(), args[6].getClass()), new CacheItem(methodHandle, method.getMethod()));
		return methodHandle;
	}
	
	@Override
	public Method7<ReturnType> add(Class<?> classInstance, String name, Class<?>... parameterTypes) {
		return (Method7<ReturnType>)super.add(classInstance, name, parameterTypes);
	}
	
	@Override
	public Method7<ReturnType> add(Object object, String name, Class<?>... parameterTypes) {
		return (Method7<ReturnType>)super.add(object, name, parameterTypes);
	}
	
	@Override
	public Method7<ReturnType> add(Class<?> classInstance, String name) {
		return (Method7<ReturnType>)super.add(classInstance, name);
	}
	
	@Override
	public Method7<ReturnType> add(Object object, String name) {
		return (Method7<ReturnType>)super.add(object, name);
	}
	
	@Override
	public Method7<ReturnType> add(Object object) {
		return (Method7<ReturnType>)super.add(object);
	}
	
	@Override
	public Method7<ReturnType> add(Cases cases) {
		return (Method7<ReturnType>)super.add(cases);
	}

	@Override
	public Method7<ReturnType> data(Comparable<?> data) {
		return (Method7<ReturnType>)super.data(data);
	}
	
	@Override
	public Method7<ReturnType> comparator(MethodComparator methodComparator) {
		return (Method7<ReturnType>)super.comparator(methodComparator);
	}
	
	@Override
	public Method7<ReturnType> symmetricComparator() {
		return (Method7<ReturnType>)super.symmetricComparator();
	}
	
	@Override
	public Method7<ReturnType> nonVirtualParameterTypes(Class<?>...types) {
		return (Method7<ReturnType>)super.nonVirtualParameterTypes(types);
	}
	
	@Override
	public Method7<ReturnType> returnType(Class<?> type) {
		return (Method7<ReturnType>)super.returnType(type);
	}
	
	@Override
	public Method7<ReturnType> notOverridable() {
		return (Method7<ReturnType>)super.notOverridable();
	}
	 ...
	 */
	public Method7<ReturnType> cache(Map<ClassTuple, CacheItem> cacheMap) {
		this.cache = cacheMap;
		return this;
	}
	 ...
	 * @return this instance
	 */
	public Method7<ReturnType> unboundedCache() {
	 ...
	 * @return this instance
	 */
	public Method7<ReturnType> boundedCache(int capacity) {
	...
	public void check(Class<?> class1, Class<?> class2, Class<?> class3, Class<?> class4, Class<?> class5, Class<?> class6, Class<?> class7) throws InvocationException {
		super.checkClassTuple(class1, class2, class3, class4, class5, class6, class7);
	}
