...
public class Method4<ReturnType> extends MultiMethod<ReturnType> {
	...
	protected MethodHandle processAndCache(Object... args) {
		...
		cache.put(new ClassTuple(args[0].getClass(), args[1].getClass(), args[2].getClass(), args[3].getClass()), new CacheItem(methodHandle, method.getMethod()));
		return methodHandle;
	}
	...
	public Method4<ReturnType> comparator(MethodComparator methodComparator) {
		return (Method4<ReturnType>)super.comparator(methodComparator);
	}
	...
	@Override
	public Method4<ReturnType> returnType(Class<?> type) {
		return (Method4<ReturnType>)super.returnType(type);
	}
	
	@Override
	public Method4<ReturnType> notOverridable() {
		return (Method4<ReturnType>)super.notOverridable();
	}
	 ...
	 */
	public Method4<ReturnType> cache(Map<ClassTuple, CacheItem> cacheMap) {
		this.cache = cacheMap;
		return this;
	}
	 ...
	 */
	public void check(Class<?> class1, Class<?> class2, Class<?> class3, Class<?> class4) throws InvocationException {
		super.checkClassTuple(class1, class2, class3, class4);
	}
	...
	public ReturnType invoke(Object arg1, Object arg2, Object arg3, Object arg4) throws Throwable {
		...
		checkVirtualArgs(arg1, arg2, arg3, arg4);
		CacheItem cacheItem = cache.get(new ClassTuple(arg1.getClass(), arg2.getClass(), arg3.getClass(), arg4.getClass()));
