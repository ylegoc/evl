...
public class Method2<ReturnType> extends MultiMethod<ReturnType> {
	...
	@Override
	public Method2<ReturnType> symmetricComparator() {
		return (Method2<ReturnType>)super.symmetricComparator();
	}
	
	@Override
	public Method2<ReturnType> nonVirtualParameterTypes(Class<?>...types) {
		return (Method2<ReturnType>)super.nonVirtualParameterTypes(types);
	}
	
	@Override
	public Method2<ReturnType> returnType(Class<?> type) {
		return (Method2<ReturnType>)super.returnType(type);
	}
	
	@Override
	public Method2<ReturnType> notOverridable() {
		return (Method2<ReturnType>)super.notOverridable();
	}
	 ...
	 */
	public void check(Class<?> class1, Class<?> class2) throws InvocationException {
		super.checkClassTuple(class1, class2);
	}
