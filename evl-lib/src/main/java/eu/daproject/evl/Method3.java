...
public class Method3<ReturnType> extends MultiMethod<ReturnType> {
	...
	public Method3() {
		...
		this.cache = CacheFactory.<ClassTuple, CacheItem>createBoundedCache(1000);
	}
	...
	protected MethodHandle processAndCache(Object... args) {
		...
		cache.put(new ClassTuple(args[0].getClass(), args[1].getClass(), args[2].getClass()), new CacheItem(methodHandle, method.getMethod()));
		return methodHandle;
	}
	...
	@Override
	public Method3<ReturnType> notOverridable() {
		return (Method3<ReturnType>)super.notOverridable();
	}
	 ...
	 */
	public Method3<ReturnType> cache(Map<ClassTuple, CacheItem> cacheMap) {
		this.cache = cacheMap;
		return this;
	}
